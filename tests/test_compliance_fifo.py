...
class TestOpenLot:
    def test_open_creates_lot(self):
        ledger = _ledger()
        lot = ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("10"), "strat_1")
        assert lot.trade_id
    ...
    def test_open_size_tracked(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "long", Decimal("2.0"), Decimal("50000"), Decimal("10"), "strat_1")
...
class TestClosePosition:
    def test_simple_full_close(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("10"), "s1", _dt(0))
        records = ledger.close_position(
            "BTCUSDT", "long", Decimal("1.0"), Decimal("51000"),
            exit_fees=Decimal("10"), funding_paid_received=Decimal("0"),
    ...
    def test_long_profit_calculation(self):
        ...
        records = ledger.close_position(
            "BTCUSDT", "long", Decimal("1.0"), Decimal("51000"),
            exit_fees=Decimal("10"), funding_paid_received=Decimal("5"),
            exchange_rate=Decimal("1.0"),
        )
    ...
    def test_short_profit_calculation(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "short", Decimal("1.0"), Decimal("51000"), Decimal("10"), "s1", _dt(0))
        records = ledger.close_position(
            "BTCUSDT", "short", Decimal("1.0"), Decimal("50000"),
            exit_fees=Decimal("10"), funding_paid_received=Decimal("0"),
            exchange_rate=Decimal("1.0"),
        )
        # gross = (51000 - 50000) * 1 = 1000
    ...
    def test_long_loss_calculation(self):
        ...
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("10"), "s1", _dt(0))
        records = ledger.close_position(
            "BTCUSDT", "long", Decimal("1.0"), Decimal("49000"),
            exit_fees=Decimal("10"), funding_paid_received=Decimal("0"),
            exchange_rate=Decimal("1.0"),
        )
    ...
    def test_partial_close_leaves_remainder(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "long", Decimal("2.0"), Decimal("50000"), Decimal("20"), "s1", _dt(0))
        ledger.close_position(
            "BTCUSDT", "long", Decimal("1.0"), Decimal("51000"),
            exit_fees=Decimal("5"), funding_paid_received=Decimal("0"),
            exchange_rate=Decimal("1.0"),
        )
    ...
    def test_close_spans_two_lots_fifo_order(self):
        ...
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("40000"), Decimal("5"), "s1", _dt(0))
        # Lot B: opened second (newer)
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("5"), "s1", _dt(1))

        records = ledger.close_position(
            "BTCUSDT", "long", Decimal("2.0"), Decimal("55000"),
            exit_fees=Decimal("10"), funding_paid_received=Decimal("0"),
            exchange_rate=Decimal("1.0"),
        )
    ...
    def test_close_size_exceeds_available_raises(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("5"), "s1", _dt(0))
        with pytest.raises(ValueError, match="Cannot close"):
            ledger.close_position(
                "BTCUSDT", "long", Decimal("2.0"), Decimal("51000"),
                exit_fees=Decimal("5"), funding_paid_received=Decimal("0"),
                exchange_rate=Decimal("1.0"),
            )
    ...
    def test_funding_included_in_pnl(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("0"), "s1", _dt(0))
        records = ledger.close_position(
            "BTCUSDT", "long", Decimal("1.0"), Decimal("50000"),  # breakeven on price
            exit_fees=Decimal("0"), funding_paid_received=Decimal("100"),
            exchange_rate=Decimal("1.0"),
        )
...
class TestLoadLots:
    def test_load_restores_state(self):
        ledger = _ledger()
        lots = [
            LotData("id1", "BTCUSDT", "long", Decimal("50000"),
                    Decimal("1.0"), Decimal("1.0"), Decimal("5"), "s1", _dt(0)),
        ]
    ...
    def test_load_preserves_fifo_order(self):
        ...
        ledger = _ledger()
        lots = [
            LotData("id2", "BTCUSDT", "long", Decimal("51000"),
                    Decimal("1.0"), Decimal("1.0"), Decimal("5"), "s1", _dt(1)),
            LotData("id1", "BTCUSDT", "long", Decimal("50000"),
                    Decimal("1.0"), Decimal("1.0"), Decimal("5"), "s1", _dt(0)),
        ]
        ledger.load_lots(lots)
...
class TestTradeRecord11Fields:
    def test_all_11_fields_present(self):
        ledger = _ledger()
        ledger.open_lot("BTCUSDT", "long", Decimal("1.0"), Decimal("50000"), Decimal("5"), "strategy_abc", _dt(0))
        records = ledger.close_position(
            "BTCUSDT", "long", Decimal("1.0"), Decimal("51000"),
            exit_fees=Decimal("5"), funding_paid_received=Decimal("2"),
