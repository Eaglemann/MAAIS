...
def _policy(command) -> LivePaperPolicy:
    ...
    return LivePaperPolicy(
        ...
        fee_venue="binance_usdm",
        fee_tier="regular_user",
        fee_settlement_asset="USDT",
        fee_discount="none",
        fee_schedule_source="https://www.binance.com/en/fee/trading",
        fee_schedule_verified_at=command.manifest.created_at,
        leverage=1,
